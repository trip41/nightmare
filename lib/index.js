...
Nightmare.prototype.waitForElement = function(selector, opts, done) {
  ...
  var elementPresent = function(next) {
    self.page.evaluate(function (selector, opts) {
      try {
        var element;
        if(opts.iframe && document.querySelector('iframe')) {
          element = document.querySelector('iframe').contentDocument.querySelector(selector);
        } else {
...
function getDomDataForSelector(selector, opts) {
  ...
  try {
    var elements;
    if(opts.iframe && document.querySelector('iframe')) {
      elements = Array.prototype.slice.call(document.querySelector('iframe').contentDocument.querySelectorAll(selector));
    } else {
